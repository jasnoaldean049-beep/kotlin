...
internal class JvmCompilerArgumentsImpl() : CommonCompilerArgumentsImpl(), JvmCompilerArguments,
  ...
  public fun toCompilerArguments(arguments: K2JVMCompilerArguments = K2JVMCompilerArguments()): K2JVMCompilerArguments {
    ...
    if (X_ABI_STABILITY in this) { try { arguments.abiStability = get(X_ABI_STABILITY)?.stringValue } catch(e: ClassCastException) { arguments.applyAbiStability(get(X_ABI_STABILITY)) }}
    if (X_ADD_MODULES in this) { try { arguments.additionalJavaModules = get(X_ADD_MODULES)?.toTypedArray() } catch(e: ClassCastException) { arguments.applyAdditionalJavaModules(get(X_ADD_MODULES)) }}
    ...
    if (X_ASSERTIONS in this) { try { arguments.assertionsMode = get(X_ASSERTIONS)?.stringValue } catch(e: ClassCastException) { arguments.applyAssertionsMode(get(X_ASSERTIONS)) }}
    ...
    if (X_JSPECIFY_ANNOTATIONS in this) { try { arguments.jspecifyAnnotations = get(X_JSPECIFY_ANNOTATIONS)?.stringValue } catch(e: ClassCastException) { arguments.applyJspecifyAnnotations(get(X_JSPECIFY_ANNOTATIONS)) }}
    ...
    if (X_SAM_CONVERSIONS in this) { try { arguments.samConversions = get(X_SAM_CONVERSIONS).stringValue } catch(e: ClassCastException) { arguments.applySamConversions(get(X_SAM_CONVERSIONS)) }}
    ...
    try { if (X_WHEN_EXPRESSIONS in this) { try { arguments.whenExpressionsGeneration = get(X_WHEN_EXPRESSIONS)?.stringValue } catch(e: ClassCastException) { arguments.applyWhenExpressionsGeneration(get(X_WHEN_EXPRESSIONS)) }} } catch (e: NoSuchMethodError) { throw IllegalStateException("""Compiler parameter not recognized: X_WHEN_EXPRESSIONS. Current compiler version is: $KC_VERSION, but the argument was introduced in 2.2.20""").initCause(e) }
  ...
  public fun applyCompilerArguments(arguments: K2JVMCompilerArguments) {
    ...
    try { try { this[X_ABI_STABILITY] = arguments.abiStability?.let { AbiStabilityMode.entries.firstOrNull { entry -> entry.stringValue == it } ?: throw CompilerArgumentsParseException("Unknown -Xabi-stability value: $it") } } catch (e: ClassCastException) { applyAbiStability(this[X_ABI_STABILITY], arguments) } } catch (_: NoSuchMethodError) {  }
    try { try { this[X_ADD_MODULES] = arguments.additionalJavaModules?.toList() } catch (e: ClassCastException) { applyAdditionalJavaModules(this[X_ADD_MODULES], arguments) } } catch (_: NoSuchMethodError) {  }
    ...
    try { try { this[X_ASSERTIONS] = arguments.assertionsMode?.let { AssertionsMode.entries.firstOrNull { entry -> entry.stringValue == it } ?: throw CompilerArgumentsParseException("Unknown -Xassertions value: $it") } } catch (e: ClassCastException) { applyAssertionsMode(this[X_ASSERTIONS], arguments) } } catch (_: NoSuchMethodError) {  }
    ...
    try { try { this[X_JSPECIFY_ANNOTATIONS] = arguments.jspecifyAnnotations?.let { JspecifyAnnotationsMode.entries.firstOrNull { entry -> entry.stringValue == it } ?: throw CompilerArgumentsParseException("Unknown -Xjspecify-annotations value: $it") } } catch (e: ClassCastException) { applyJspecifyAnnotations(this[X_JSPECIFY_ANNOTATIONS], arguments) } } catch (_: NoSuchMethodError) {  }
    ...
    try { try { this[X_SAM_CONVERSIONS] = arguments.samConversions.let { SamConversionsMode.entries.firstOrNull { entry -> entry.stringValue == it } ?: throw CompilerArgumentsParseException("Unknown -Xsam-conversions value: $it") } } catch (e: ClassCastException) { applySamConversions(this[X_SAM_CONVERSIONS], arguments) } } catch (_: NoSuchMethodError) {  }
    ...
    try { try { this[X_WHEN_EXPRESSIONS] = arguments.whenExpressionsGeneration?.let { WhenExpressionsMode.entries.firstOrNull { entry -> entry.stringValue == it } ?: throw CompilerArgumentsParseException("Unknown -Xwhen-expressions value: $it") } } catch (e: ClassCastException) { applyWhenExpressionsGeneration(this[X_WHEN_EXPRESSIONS], arguments) } } catch (_: NoSuchMethodError) {  }
