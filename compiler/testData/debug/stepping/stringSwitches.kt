...
// EXPECTATIONS WASM
// test.kt:30 $box (17, 4)
// test.kt:6 $stringSwitch (8, 13, 8, 20)
// test.kt:5 $stringSwitch (12)
// test.kt:12 $stringSwitch (19)
// test.kt:13 $stringSwitch (8, 15)
// test.kt:12 $stringSwitch (13)
// test.kt:20 $stringSwitch (9)
// test.kt:22 $stringSwitch (8, 15)
// test.kt:19 $stringSwitch (13)
// test.kt:27 $stringSwitch (1)
// test.kt:30 $box (4)
// test.kt:31 $box (17, 4)
// test.kt:6 $stringSwitch (8, 13, 8)
// test.kt:7 $stringSwitch (8, 13, 8, 21)
// test.kt:5 $stringSwitch (12)
// test.kt:12 $stringSwitch (19)
// test.kt:13 $stringSwitch (8)
// test.kt:14 $stringSwitch (8, 16)
// test.kt:12 $stringSwitch (13)
// test.kt:20 $stringSwitch (9)
// test.kt:22 $stringSwitch (8)
...
// test.kt:32 $box (17, 4)
// test.kt:6 $stringSwitch (8, 13, 8)
// test.kt:7 $stringSwitch (8, 13, 8)
// test.kt:8 $stringSwitch (8, 13, 8, 22)
// test.kt:5 $stringSwitch (12)
// test.kt:12 $stringSwitch (19)
// test.kt:13 $stringSwitch (8)
// test.kt:14 $stringSwitch (8)
// test.kt:15 $stringSwitch (8, 17)
// test.kt:12 $stringSwitch (13)
// test.kt:20 $stringSwitch (9)
// test.kt:22 $stringSwitch (8)
// test.kt:23 $stringSwitch (8)
...
// test.kt:6 $stringSwitch (8, 13, 8)
// test.kt:7 $stringSwitch (8, 13, 8)
// test.kt:8 $stringSwitch (8, 13, 8)
// test.kt:9 $stringSwitch (16)
// test.kt:5 $stringSwitch (12)
// test.kt:12 $stringSwitch (19)
// test.kt:13 $stringSwitch (8)
// test.kt:14 $stringSwitch (8)
// test.kt:15 $stringSwitch (8)
// test.kt:16 $stringSwitch (16)
// test.kt:12 $stringSwitch (13)
// test.kt:20 $stringSwitch (9)
// test.kt:22 $stringSwitch (8)
// test.kt:23 $stringSwitch (8)
// test.kt:24 $stringSwitch (8)
