...
object FirErrors : KtDiagnosticsContainer() {
    ...
    val EXPLICIT_TYPE_ARGUMENTS_IN_PROPERTY_ACCESS_WARNING: KtDiagnosticFactory1<String> = KtDiagnosticFactory1("EXPLICIT_TYPE_ARGUMENTS_IN_PROPERTY_ACCESS_WARNING", ERROR, SourceElementPositioningStrategies.TYPE_ARGUMENT_LIST_OR_WITHOUT_RECEIVER, KtExpression::class, getRendererFactory())
