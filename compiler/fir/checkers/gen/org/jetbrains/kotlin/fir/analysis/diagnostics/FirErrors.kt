...
object FirErrors : KtDiagnosticsContainer() {
    ...
    val WRONG_NUMBER_OF_TYPE_ARGUMENTS_IN_GET_CLASS_WARNING: KtDiagnosticFactory2<Int, FirBasedSymbol<*>> = KtDiagnosticFactory2("WRONG_NUMBER_OF_TYPE_ARGUMENTS_IN_GET_CLASS_WARNING", ERROR, SourceElementPositioningStrategies.TYPE_ARGUMENT_LIST_OR_SELF, PsiElement::class, getRendererFactory())
    ...
    val CLASS_LITERAL_LHS_NOT_A_CLASS_WARNING: KtDiagnosticFactory0 = KtDiagnosticFactory0("CLASS_LITERAL_LHS_NOT_A_CLASS_WARNING", ERROR, SourceElementPositioningStrategies.DEFAULT, KtExpression::class, getRendererFactory())
