...
class JspecifyAnnotationsModeType(
    ...
    override val defaultValue: ReleaseDependent<JspecifyAnnotationsMode?> = ReleaseDependent(
        ...
        KotlinReleaseVersion.v1_4_30..KotlinReleaseVersion.v2_0_21 to JspecifyAnnotationsMode.WARN
    ),
...
class CompatqualAnnotationsModeType(
    override val isNullable: ReleaseDependent<Boolean> = ReleaseDependent(true),
    override val defaultValue: ReleaseDependent<CompatqualAnnotationsMode?> = ReleaseDependent(CompatqualAnnotationsMode.ENABLE),
